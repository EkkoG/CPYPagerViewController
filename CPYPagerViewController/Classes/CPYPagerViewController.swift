...
public protocol CPYPagerViewControllerDatasource: NSObjectProtocol {
...
public protocol CPYTabViewDelegate: NSObjectProtocol {
    func titlesOfTab(_ tabView: CPYTabView) -> [String]
    func selectedButton(_ tabView: CPYTabView, index:Int)
}


open class CPYPagerViewController: UIViewController, CPYTabViewDelegate, UIScrollViewDelegate {
    ...
    weak open var dataSource: CPYPagerViewControllerDatasource?
...
//        self.view.backgroundColor = UIColor.redColor()
    ...
    public func titlesOfTab(_ tabView: CPYTabView) -> [String] {
        return titles
    }
    
    public func selectedButton(_ tabView: CPYTabView, index: Int) {
